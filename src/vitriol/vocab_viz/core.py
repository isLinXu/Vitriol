...
class VocabVisualizer:
    ...
    def add_model_from_id(self, model_id: str, family: str = "Custom", trust_remote_code: bool = True):
    ...
    def generate_single_distribution(self, model_id: str, output_path: str = "vocab_dist.html", plot_type: str = "treemap", trust_remote_code: bool = True):
